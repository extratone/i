...
void SVGElement::parseAttribute(const QualifiedName& name, const AtomicString& value)
{
    ...
    if (name == onloadAttr)
        ...
        setAttributeEventListener(eventNames().gesturestartEvent, createAttributeEventListener(this, name, value));
    else if (name == ongesturechangeAttr)
        setAttributeEventListener(eventNames().gesturechangeEvent, createAttributeEventListener(this, name, value));
    else if (name == ongestureendAttr)
        setAttributeEventListener(eventNames().gestureendEvent, createAttributeEventListener(this, name, value));
#endif
    else
