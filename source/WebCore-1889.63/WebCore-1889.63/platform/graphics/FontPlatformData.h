...
return m_font ? m_font->hash() : 0;
        ...
        uintptr_t hashCodes[3] = { (uintptr_t)CFHash(m_font), m_widthVariant, static_cast<uintptr_t>(m_isEmoji << 4 | m_isPrinterFont << 3 | m_orientation << 2 | m_syntheticBold << 1 | m_syntheticOblique) };
#endif // !PLATFORM(IOS)
