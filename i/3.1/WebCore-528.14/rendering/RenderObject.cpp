...
// Like addLineBoxRects, this function is a no-op in the class.
void RenderObject::collectSelectionRects(Vector<SelectionRect>&, unsigned, unsigned)
{
}
...
StyleDifference RenderObject::adjustStyleDifference(StyleDifference diff, unsigned contextSensitiveProperties) const
{
    ...
    if (contextSensitiveProperties & ContextSensitivePropertyTransform)
        ...
        if (!isText() && (!hasLayer() || !toRenderBox(this)->layer()->isComposited()))
...
void RenderObject::mapLocalToContainer(RenderBox* repaintContainer, bool fixed, bool useTransforms, TransformState& transformState) const
{
    if (repaintContainer == this)
        return;
...
RenderStyle* RenderObject::firstLineStyle() const
{
    ...
    } else if (!obj->isAnonymous() && obj->isRenderInline() && obj->parent()) {
