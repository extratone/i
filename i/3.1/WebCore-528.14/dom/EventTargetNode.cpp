...
void EventTargetNode::addEventListener(const AtomicString& eventType, PassRefPtr<EventListener> listener, bool useCapture)
{
    ...
    if (eventType == eventNames().orientationchangeEvent || eventType == eventNames().resizeEvent) {
        document->addWindowEventListener(eventType, listener, useCapture);
        return;
    }
...
void EventTargetNode::removeEventListener(const AtomicString& eventType, EventListener* listener, bool useCapture)
{
    ...
    if (eventType == eventNames().orientationchangeEvent || eventType == eventNames().resizeEvent) {
        document()->removeWindowEventListener(eventType, listener, useCapture);
        return;
    }
...
bool EventTargetNode::willRespondToMouseMoveEvents()
{
    ...
    return Node::willRespondToMouseMoveEvents() || containsListenerTypes(eventListeners(), eventTypes);
}
...
bool EventTargetNode::willRespondToMouseWheelEvents()
{
    ...
    return Node::willRespondToMouseWheelEvents() || containsListenerTypes(eventListeners(), eventTypes);
}
...
bool EventTargetNode::willRespondToMouseClickEvents()
{
    ...
    return Node::willRespondToMouseClickEvents() || containsListenerTypes(eventListeners(), eventTypes);
}
...
EventListener* EventTargetNode::onorientationchange() const
{
    return inlineEventListenerForType(eventNames().orientationchangeEvent);
}

void EventTargetNode::setOnorientationchange(PassRefPtr<EventListener> eventListener)
{
...
EventListener* EventTargetNode::ongesturestart() const
{
    return inlineEventListenerForType(eventNames().gesturestartEvent);
}

void EventTargetNode::setOngesturestart(PassRefPtr<EventListener> eventListener)
{
    setInlineEventListenerForType(eventNames().gesturestartEvent, eventListener);
}

EventListener* EventTargetNode::ongesturechange() const
{
    return inlineEventListenerForType(eventNames().gesturechangeEvent);
}

void EventTargetNode::setOngesturechange(PassRefPtr<EventListener> eventListener)
{
    setInlineEventListenerForType(eventNames().gesturechangeEvent, eventListener);
}

EventListener* EventTargetNode::ongestureend() const
{
    return inlineEventListenerForType(eventNames().gestureendEvent);
}

void EventTargetNode::setOngestureend(PassRefPtr<EventListener> eventListener)
{
